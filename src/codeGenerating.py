...
def generateGPTAnswer(prompt, api_key="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", model="gpt-3.5-turbo"):
    """
...
def main():
    ...
    result_filename = os.path.join(args.output_dir, 'result.csv')
